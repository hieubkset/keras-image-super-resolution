clear;close all;
% settings
folder = '../data/test/Merge/HR/';
savepath = '../data/test/Aug/';
size_input = 74;
%scale 
scale = 4; 
...
for index = 1 : length(filepaths)
        ...
        if H > 296 && W > 296
            ...
            imwrite(subim_label2, fullfile(savepath,'HR',[filepaths(i).name(1:end-5) '_' num2str(do_write) '.png']));
            imwrite(subim_input2, fullfile(savepath,'LR',[filepaths(i).name(1:end-5) '_' num2str(do_write) '.png']));
            end
